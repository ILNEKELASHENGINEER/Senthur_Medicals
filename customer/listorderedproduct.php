		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : &#8377 <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : &#8377 <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : &#8377 <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
